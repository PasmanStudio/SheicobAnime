...
{
    /// <inheritdoc />
    public partial class EnsureDiscordPostsTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // SyncDiscordPostModel was applied as a no-op (empty Up) on first deploy.
            // This migration guarantees discord_posts exists using IF NOT EXISTS — idempotent
            // whether the table was already created manually or not.
...
");
        ...
        {
            // Leave intact — may have been created manually before this migration ran.
        }
    }
}
