...
{
    /// <summary>
    /// The AddTelegramPosts migration was written with raw SQL, which means
    /// EF's PendingModelChangesWarning caused the scraper to crash before
    /// MigrateAsync could ever apply it. This migration ensures the table
    /// exists regardless of whether the first one was applied.
    /// </summary>
    public partial class EnsureTelegramPostsTable : Migration
    {
