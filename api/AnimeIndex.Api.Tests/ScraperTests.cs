...
public class ScraperTests
{
    ...
    public void Source2Strategy_SourceKey_IsSource2()
    {
        ...
        var strategy = new Source2Strategy(db, upsert, http, null, null, null, config, NullLogger<Source2Strategy>.Instance);
    ...
    public void Source2Strategy_Implements_IScrapeStrategy()
    {
        ...
        IScrapeStrategy s2 = new Source2Strategy(db, upsert, http, null, null, null, config, NullLogger<Source2Strategy>.Instance);
