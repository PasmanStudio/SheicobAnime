          ...
          <nav className="container mx-auto px-4 py-3 flex flex-col gap-1">
            ...
            {DISCORD_INVITE && (
              <Link
                ...
                onClick={() => setOpen(false)}
                className="px-3 py-2.5 rounded-md text-sm font-medium text-neutral-400 hover:text-white hover:bg-neutral-800/60 transition-colors flex items-center gap-2"
              >
