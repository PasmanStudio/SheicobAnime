...
export default function LoginModal({ onClose }: LoginModalProps) {
  ...
  return createPortal(
    ...
    >
      <div className="relative w-full max-w-sm rounded-modal bg-abyss-2 border border-line-2 p-8 shadow-2xl">
        {/* Close button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-1.5 rounded-btn text-ink-3 hover:text-white hover:bg-abyss-3 transition-colors"
          aria-label="Cerrar"
        >
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-btn bg-white text-neutral-900 font-semibold hover:bg-neutral-100 active:scale-[0.98] transition-all"
          >
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-btn bg-[#5865F2] text-white font-semibold hover:bg-[#4752c4] active:scale-[0.98] transition-all"
          >
