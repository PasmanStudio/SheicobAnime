      ...
      <div className="relative w-full max-w-sm rounded-2xl bg-neutral-900 border border-neutral-700 p-8 shadow-2xl">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-white text-neutral-900 font-semibold hover:bg-neutral-100 active:scale-[0.98] transition-all"
          >
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-[#5865F2] text-white font-semibold hover:bg-[#4752c4] active:scale-[0.98] transition-all"
          >
