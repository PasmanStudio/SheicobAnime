...
export const metadata: Metadata = {
  title: "Apoyanos",
  description:
    "SheicobAnime no tiene paywall ni popups. Si esta página es tu manera de mirar anime, invitanos un café.",
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <div className="sh-body space-y-4 text-[15px]">
        <p>
          SheicobAnime no tiene paywall, no tiene popups y no te interrumpe el episodio
          con anuncios. Lo único que hay son un par de banners que nunca se cruzan en tu
          camino al play.
        </p>
        <p>
          Pero los servidores cuestan plata todos los meses. Si esta página es tu manera
          de mirar anime, podés bancarla <strong className="text-ink-1">invitándonos un café</strong> —
          una vez, cuando quieras, sin suscripción.
        </p>
        <p>
      ...
      <div className="mt-8 flex flex-wrap items-center gap-3">
        {KOFI_URL ? (
          ...
          >
            ♥ Invitanos un café en Ko-fi
          </Link>
        ) : (
          <span className="text-sm text-ink-3">
            El link de Ko-fi se está configurando — volvé pronto.
          </span>
        )}
        <Link
          href="/"
